  ...
  return [
    {
      id: 'req_1',
      name: 'Sarah Jenkins',
      location: 'Sector 4, West End (Near Community Park)',
      contact: '+1 (555) 019-2834',
      help_type: 'Food & Water',
      priority: 'High',
      description: 'Family of 4 without clean drinking water and food since the main water line burst last night.',
      status: 'Pending',
    ...
    },
    {
      id: 'req_2',
      name: 'Robert Diaz',
      location: 'Apartment 3B, 112 Riverside Avenue',
      contact: '+1 (555) 014-9982',
    ...
    },
    {
      ...
      location: 'North Gym Shelter (Cot #14)',
      contact: '+1 (555) 012-7364',
    ...
    },
    {
      id: 'req_4',
      name: 'Elena Rostova',
      location: 'Block C, Oakridge Subdivison',
      contact: '+1 (555) 018-4721',
    ...
    },
    {
      id: 'req_5',
      name: 'Marcus Brody',
      location: 'Intersection of Elm & 5th St',
      contact: '+1 (555) 011-2358',
